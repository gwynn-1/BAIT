...
class Comment_bookCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Comment_book');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/comment_book');
        $this->crud->setEntityNameStrings('comment_book', 'comment_book');
