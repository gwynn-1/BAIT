...
use App\Http\Requests\Comment_blogRequest as StoreRequest;
use App\Http\Requests\Comment_blogRequest as UpdateRequest;
use Illuminate\Support\Facades\DB;

class Comment_blogCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Comment_blog');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/comment_blog');
        $this->crud->setEntityNameStrings('comment_blog', 'comment_blogs');
        ...
        */
        ...
        // ------ CRUD FIELDS
         $this->crud->addField(
             ...
             'type'  => 'number'], 'create');
         $this->crud->addFields([
             ['name'  => 'id_blog', // DB column name (will also be the name of the input)
                 'label' => 'Blog & News', // the human-readable label for the input
                 'type'  => 'select2',
                 'entity'=>'blog_news',
                 'attribute'=>'name',
                 'model'=>'App\Models\Blog_news'],
    ...
    {
        DB::statement("ALTER TABLE comment_blog AUTO_INCREMENT=1");
