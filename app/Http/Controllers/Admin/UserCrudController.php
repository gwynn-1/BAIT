...
class UserCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/user-read');
        ...
        */
        ...
        $this->crud->setListView("backpack::crud.list_user");
//        $this->crud->setFromDb();
    ...
    {
        $query = DB::table("users")->select("id","name","email","created_at","updated_at")->get();
        excelSpout::exportExcel(['id','tên','email','created_at','updated_at']
            ,"users","users",$query);
    }
