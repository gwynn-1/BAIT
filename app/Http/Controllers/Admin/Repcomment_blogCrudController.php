...
use App\Http\Requests\Repcomment_blogRequest as StoreRequest;
use App\Http\Requests\Repcomment_blogRequest as UpdateRequest;
use Illuminate\Support\Facades\DB;

class Repcomment_blogCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Repcomment_blog');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/repcomment_blog');
        $this->crud->setEntityNameStrings('repcomment_blog', 'repcomment_blogs');
        ...
        */
        ...
        $this->crud->addColumns([
            ...
            ['name'  => 'id_comment', // DB column name (will also be the name of the input)
                'label' => 'Bình luận Blog', // the human-readable label for the input
                'type'  => 'select',
                'entity'=>'comment_blog',
                'attribute'=>'content',
                'model'=>'App\Models\Comment_blog'],
            ['name'  => 'id_reader', // DB column name (will also be the name of the input)
                'label' => 'Độc giả', // the human-readable label for the input
                'type'  => 'select',
                'entity'=>'readers',
    ...
    {
        DB::statement("ALTER TABLE repcomment_blog AUTO_INCREMENT=1");
