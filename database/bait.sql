...
(1, 'Đánh thức con người phi thường trong bạn', 'mmm', 1, 'Anthony Robbins', '', 20, 20, 7, 0, 'danh-thuc-con-nguoi-phi-thuong-trong-ban', '2017-12-24 14:26:07', '2018-01-01 22:52:44'),
...
(42, 'Bơ đi mà sống', 'sách mới', 2, 'Mèo Xù', 'bo-di-ma-song.jpg', 20, 8, 7, 1, 'bo-di-ma-song', '2017-12-24 14:26:12', '2017-12-24 14:26:34'),
...
ALTER TABLE `book_type`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `type_url` (`type_url`);
