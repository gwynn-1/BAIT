...
<div <?php echo $__env->make('crud::inc.field_wrapper_attributes', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> >
    <input type="hidden" name="<?php echo e($field['name']); ?>" value="<?php echo e(old($field['name']) ? old($field['name']) : (isset($field['value']) ? $field['value'] : (isset($field['default']) ? $field['default'] : '' ))); ?>">
    <label><?php echo $field['label']; ?></label>
    <?php echo $__env->make('crud::inc.field_translatable_icon', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <div class="input-group date">
        <input
            data-bs-datetimepicker="<?php echo e(isset($field['datetime_picker_options']) ? json_encode($field['datetime_picker_options']) : '{}'); ?>"
            type="text"
...
<?php if($crud->checkIfFieldIsFirstOfItsType($field, $fields)): ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('vendor/adminlte/plugins/datepicker/datepicker3.css')); ?>">
    ...
    <?php if($field_language !== 'en'): ?>
        <script charset="UTF-8" src="<?php echo e(asset('vendor/adminlte/plugins/datepicker/locales/bootstrap-datepicker.'.$field_language.'.js')); ?>"></script>
