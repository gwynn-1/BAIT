...
<body class="hold-transition <?php echo e(config('backpack.base.skin')); ?> sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo e(url('admin')); ?>" class="logo">
          ...
          <span class="logo-mini"><img src="<?php echo e(asset('')); ?>/images/logo-bait.png" width="40" height="40"/></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><img src="<?php echo e(asset('')); ?>/images/logo-bait.png" width="45" height="45"/>    <b>Admin</b></span>
        </a>
    ...
    <script>window.jQuery || document.write('<script src="<?php echo e(asset('vendor/adminlte')); ?>/plugins/jQuery/jQuery-2.2.3.min.js"><\/script>')</script>
    <!-- Bootstrap 3.3.5 -->
