<div class="books-container">
    ...
    <div class="col-sm-3 item-book-col">
        <div class="item-book item-all-book">
            <div class="head-item">
                <div class="borrow-button" data-id="<?php echo e($book->id); ?>" data-name="<?php echo e($book->name); ?>" data-author="<?php echo e($book->author); ?>" data-image="<?php echo e(($book->image==null) ? "images/convallis-pharetra.jpg": "book_image/".$book->image); ?>">
                    Quan tâm sách
                </div>
